...
Statement stmt=(Statement)con.createStatement();
	...
	rs2=st4.executeQuery(sql5);
		...
		response.sendRedirect(redirectURL); 
                        ...
                        String sql6 = "update score set lvl2= -50 where email='"+session.getAttribute("email")+"'";
			stmt1.executeUpdate(sql6);
                        System.out.println("score -");
        }
        
// String sql3="update score set time='"+Integer.parseInt(distance1)+"'where email='"+session.getAttribute("email")+"'";
